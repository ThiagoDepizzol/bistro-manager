...
public class RestaurantConfiguration {
    ...
    @Bean
    RestaurantGateway createdRestaurantGateway(final RestaurantMapper restaurantMapper, final RestaurantRepository restaurantRepository, final LocationUseCase locationUseCase) {
        return new RestaurantRepositoryGateway(restaurantMapper, restaurantRepository, locationUseCase);
    }
